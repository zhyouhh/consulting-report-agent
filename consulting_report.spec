...
# Docx export: pandoc reference-doc template (repo asset generated by
# scripts/build_docx_reference.py; report_tools resolves it via get_base_path()).
datas.append(('templates/docx', 'templates/docx'))
