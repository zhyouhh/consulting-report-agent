...
> **⚠️ SUPERSEDED 2026-05-06**: 实施已完成且 packaged 6.3 smoke 已通过。下一步看 [`2026-05-06-tools-redesign-complete.md`](2026-05-06-tools-redesign-complete.md)。本文件保留作为历史 context。
