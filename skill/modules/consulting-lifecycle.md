...
- `plan/progress.md` 记录当前执行状态，不单独决定跳阶段
- `plan/tasks.md` 负责把当前阶段拆成可执行事项
...
| S5 质量审查 | 完成系统复核 | 勾选审查清单、记录修订意见、消除结构和表述问题 | `review-checklist.md` `review.md` |
...
3. 在 `progress.md` 中登记当前任务

### S1 研究设计
1. 先做一轮必要的初步搜集
2. 把边界、假设、关键问题写入 `notes.md`
3. 把至少 2 个有效来源写入 `references.md`
4. 然后再产出 `outline.md` 与 `research-plan.md`
