...
class PriceTests(unittest.TestCase):
    def test_deepseek_three_tier_cost_matches_spec_numbers(self):
        ...
        cost = metering.price_micro_yuan("deepseek-v4-pro", hit=0, miss=1289, completion=500,
    ...
    def test_cache_hit_is_cheap(self):
        ...
        cost = metering.price_micro_yuan("deepseek-v4-pro", hit=1280, miss=9, completion=500,
                                         pricing=DEFAULT_MANAGED_MODEL_PRICING)
